            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mt-3 font-weight-bold ">Orang
                        </div>
                        <div class="row no-gutters align-items-center">
                            <div class="col-auto"> 
                            </div>
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mt-3 font-weight-bold ">Orang</div>
                        <div class="row no-gutters align-items-center">
                            <div class="col-auto"> 
                            </div>
                           <!--  <div class="col">
...
<div class="container-fluid">
    <div class="table-responsive">
        <table class="table table-bordered">
            ...
            <tbody>
                <?php
                // Assuming $rows contains the fetched data from the database
                foreach ($rows as $row) {
                    echo "<tr>";
                    echo "<td>" . htmlspecialchars($row['id_peserta']) . "</td>";
                    ...
                    echo "<td>" . htmlspecialchars($row['kewarganegaraan']) . "</td>";
                    ...
                    echo "<td>" . htmlspecialchars($row['bukti_pendaftaran']) . "</td>";
                    echo "<td>" . htmlspecialchars($row['pas_foto']) . "</td>";
                    echo "</tr>";
                }
                ?>
            </tbody>
